...
import { Heart, Upload, CheckCircle, Loader2, Award, Target, Users, Calendar } from "lucide-react";
...
const CommunityAchievementForm = () => {
  ...
  const serviceTypes = [
    ...
    { value: "ngo-collaboration", label: "NGO Collaboration" },
    ...
    { value: "environmental", label: "Environmental Service" },
    { value: "disaster-relief", label: "Disaster Relief" },
    { value: "other", label: "Other Community Service" },
  ];
  ...
  const validateForm = () => {
    try {
      communitySchema.parse(formData);
      setErrors({});
      return true;
    } catch (error) {
      ...
      toast({
        ...
        description: (
          <div className="flex items-center gap-2">
            ...
            <span>Community service achievement submitted successfully!</span>
          </div>
        ),
      });
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-none shadow-2xl">
            <CardHeader className="space-y-4 bg-gradient-to-r from-rose-600 to-pink-500 text-white rounded-t-xl">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                  <Heart className="w-8 h-8" />
                </div>
                <div>
                  <CardTitle className="text-3xl">Community Service Achievement</CardTitle>
                  <CardDescription className="text-white/90 text-lg">
                    Submit your social work, NGO activities, and volunteering experiences
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="md:col-span-2 space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="e.g., Led Health Awareness Campaign - Reached 500+ Families"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="e.g., Red Cross, Akshaya Patra, Local NGO"
                    ...
                    {calculatedPoints !== null && (
                      <div className="md:col-span-2">
                        <div className="bg-gradient-to-r from-rose-50 to-pink-50 border-2 border-rose-200 rounded-lg p-4">
                          <div className="flex items-center justify-between">
                            <div>
                              <p className="text-sm font-medium text-gray-600">Calculated Points</p>
                              <p className="text-3xl font-bold text-rose-600">{calculatedPoints}</p>
                            </div>
                    ...
                    <div className="md:col-span-2 space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Describe your community service activities, responsibilities, and contributions..."
                        rows={5}
                    ...
                    <div className="md:col-span-2 space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Describe the impact: lives touched, problems solved, community changes..."
                        rows={4}
                ...
                <div className="flex gap-4">
                  ...
                  <Button
                    ...
                    className="flex-1 bg-gradient-to-r from-rose-600 to-pink-500 hover:from-rose-700 hover:to-pink-600"
                  >
                    {isSubmitting ? (
                      <>
...
export default CommunityAchievementForm;
